...
import {Action, setPrezzoMax, setPrezzoMin} from "./Action";

function Bottoneprezzomin(){
    ...
    function handleChange(value:number){
        dispatch(setPrezzoMin(state.listaAppartamenti,value))
    }
    return (<FormControl fullWidth sx={{mx:"1em"}}>
        <InputLabel>PrezzoMin</InputLabel>
        <Select
            label={"Prezzi"}>
            {listaprezzi.map((obj)=>(
...
// @ts-ignore
export default Bottoneprezzomin