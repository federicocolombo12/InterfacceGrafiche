...
import {Action, FilterClasseEnergetica, FilterNumeroLocali, FilterPiano, FilterTipologia, setPrezzoMax} from "./Action";
...
function Bottoneprezzomax(){
    ...
    function handleChange(value:string){
        dispatch(FilterClasseEnergetica(state.listaAppartamenti,value))
    }
